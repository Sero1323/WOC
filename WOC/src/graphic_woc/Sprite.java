...
//    }
    ...
    public void draw(){
        ...
        this.spriteDoubleBufferG2D.drawImage(this.getSpriteImage(), spriteTransform,  Frame.getInstance());
    ...
    public void setSpriteTransform(AffineTransform spriteTransform) {
