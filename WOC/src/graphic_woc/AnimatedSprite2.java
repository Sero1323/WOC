 ...
 * @author Evgheni
 */
public class AnimatedSprite2 extends Sprite {
    ...
    public void draw() {
        ...
        tempSurface.drawImage(animimage, 0, 0, this.getFrameWidth() - 1, this.getFrameHeight() - 1,
                this.getFrameX(), this.getFrameY(), this.getFrameX() + this.getFrameWidth(), this.getFrameY() + this.getFrameHeight(), Frame.getInstance());
