...
public class SoldiersFrame extends javax.swing.JFrame {
    ...
    public void loadComponents(ArmyCamp a)
    {
        ...
        String labeltxt = "";
        int soldiers = 0;
        for (int i = 0; i < a.getSoldiers().size(); i++) {
            labeltxt += " "+a.getSoldiers().get(i).getName();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SoldiersFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
