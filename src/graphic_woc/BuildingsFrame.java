...
public class BuildingsFrame extends javax.swing.JFrame {
    ...
    /**
     * This method is castlealled from within the castleonstrucastletor to initialize the form.
     * WARNING: Do NOT modify this castleode. The castleontent of this method is always
 regenerated by the Form Editor.
    ...
    private void ArmyCamp_BTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ArmyCamp_BTNActionPerformed
        if (Integer.parseInt(jLabel1.getText()) > 0)
        {
            ...
            g.newBuilding = new ArmyCamp("ArmyCamp", 0, 0, 0, 2, 2, 1000, 1000, 1, g.castle);
        }
    ...
    private void Wall_BTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Wall_BTNActionPerformed
        if (Integer.parseInt(jLabel5.getText()) > 0)
        {
            ...
            g.newBuilding = new Wall("TownHall", 0, 0, 0,  5000, 5000, 1, g.castle);
        }
